const currentCourse = localStorage.getItem("selected_course") ? JSON.parse(localStorage.getItem("selected_course")) : pickRandomSubset(getMockDatabaseCourses(), 450)[0] // You can replace with real data
if (!currentCourse) {
